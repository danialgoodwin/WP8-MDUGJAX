...
namespace WPAppStudio.Repositories
{
    ...
    public class album : Ialbum 
    {
		...
		private const string RssUrl = "http://api.flickr.com/services/feeds/photos_public.gne?tags=mdugjax";
        ...
        /// <summary>
        /// Retrieves the data from a RSS data source (http://api.flickr.com/services/feeds/photos_public.gne?tags=mdugjax), in an observable collection of RssSearchResult items.
        /// </summary>
		...
		/// <summary>
        /// Retrieves the data from a RSS data source (http://api.flickr.com/services/feeds/photos_public.gne?tags=mdugjax), filtered by a filter specification, in an observable collection of RssSearchResult items.
        /// </summary>
